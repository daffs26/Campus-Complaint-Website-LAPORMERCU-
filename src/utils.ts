...
export const DEFAULT_LAPORAN: Laporan[] = [
  ...
  { id: 2, nim: '2024001', nama: 'Muhammad Daffa Aulia Syahrul', prodi: 'Sistem Informasi', judul: 'Proyektor Bermasalah', kategori: 'Gedung / Ruang Kelas', lokasi: 'Ruang 301 Gedung A', deskripsi: 'Proyektor tidak bisa menampilkan gambar dengan jelas, layar tampak buram dan redup.', tanggal: '2025-01-10', status: 'Selesai', rating: 5, feedback: 'Proyektor sudah diganti baru, layarnya sangat jernih sekarang. Terima kasih!' },
  ...
  { id: 4, nim: '2024002', nama: 'Daffa Aulia', prodi: 'Sistem Informasi', judul: 'Lampu Parkir Mati', kategori: 'Parkiran', lokasi: 'Parkiran Belakang Kampus', deskripsi: 'Lampu penerangan di parkiran belakang mati sejak seminggu lalu.', tanggal: '2025-01-12', status: 'Selesai', rating: 4, feedback: 'Penerangan cukup baik sekarang.' },
  { id: 5, nim: '2024001', nama: 'Muhammad Daffa Aulia Syahrul', prodi: 'Sistem Informasi', judul: 'Wifi Perpustakaan Lambat', kategori: 'Perpustakaan', lokasi: 'Perpustakaan Pusat', deskripsi: 'Koneksi wifi di perpustakaan sangat lambat.', tanggal: '2025-01-17', status: 'Baru' },
